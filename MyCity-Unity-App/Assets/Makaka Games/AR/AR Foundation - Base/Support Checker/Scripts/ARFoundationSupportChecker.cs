...
public class ARFoundationSupportChecker : MonoBehaviour
{
    ...
    private IEnumerator CheckCoroutine()
    {
        ...
        DebugPrinter.Print("▶▶▶ ARF: Checking for support...");

        yield return ARSession.CheckAvailability();

        if (ARSession.state == ARSessionState.NeedsInstall)
        {
            DebugPrinter.Print("▶▶▶ ARF: is Supported, but requires a software update.");
            DebugPrinter.Print("▶▶▶ ARF: Attempting install...");
        ...
        {
            DebugPrinter.Print("▶▶▶ ARF: is Supported!");
            DebugPrinter.Print("▶▶▶ ARF: Starting AR session...");
            ...
            if (isCheckedFaceTrackingForIOS)
            {
                ...
                {
                    DebugPrinter.Print("▶▶▶ ARF: Face Tracking is Supported!");

                    Success();
                }
                else
                {
                    DebugPrinter.Print("▶▶▶ ARF: Face Tracking is NOT Supported!");
    ...
    private void InitARIsNotSupported()
    {
        ...
        DebugPrinter.Print("▶▶▶ ARF: " + GetRequirements());
    ...
    {
        DebugPrinter.Print("▶▶▶ ARF: is Supported: Success Test in Editor."
    ...
    {
        DebugPrinter.Print(
            "▶▶▶ ARF: The software update failed, or you declined the update.");
    ...
    private IEnumerator InstallARSoftwareCoroutine()
    {
        ...
        {
            DebugPrinter.Print("▶▶▶ ARF: Error: AR Software does not require install.");
        }
    }
