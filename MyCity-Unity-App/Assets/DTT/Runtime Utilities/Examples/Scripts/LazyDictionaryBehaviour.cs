...
public class LazyDictionaryBehaviour : MonoBehaviour
{
   /// <summary>
   ...
   /// </summary>
   private readonly LazyDictionary<string, GameObject[]> _lazyDictionary = new LazyDictionary<string, GameObject[]>();
