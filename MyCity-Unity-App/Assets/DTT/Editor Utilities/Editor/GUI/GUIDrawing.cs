...
namespace DTT.Utils.EditorUtilities
{
    ...
    public static class GUIDrawing
    {
        ...
        /// <param name="drawScriptProperty">Whether the script property should be drawn.</param>
        /// <returns>A value has been changed when drawing the properties.</returns>
        public static bool DrawProperties(this SerializedObject serializedObject, bool drawScriptProperty = true)
        {
